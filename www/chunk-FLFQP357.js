  ...
  constructor() {
    ...
    collectionData(q, { idField: "id" }).subscribe((data) => {
      const transformed = data.map((p) => __spreadProps(__spreadValues({}, p), {
        ...
        reviews: (p.reviews || []).map((r) => __spreadProps(__spreadValues({}, r), {
          date: this.parseFirestoreDate(r.date)
        })),
        aiDeploymentEnabled: p.aiDeploymentEnabled === void 0 ? true : p.aiDeploymentEnabled,
...
//# sourceMappingURL=chunk-FLFQP357.js.map
