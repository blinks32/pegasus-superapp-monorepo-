...
function SellComponent_ng_container_2_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 21)(8, "a", 22);
...
function SellComponent_ng_container_2_form_13_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 37)(11, "label", 41);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 37)(17, "label", 43);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 45)(21, "div", 37)(22, "label", 46);
    \u0275\u0275text(23, "Category *");
    \u0275\u0275elementEnd();
...
function SellComponent_ng_container_2_form_13_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 45)(5, "div", 37)(6, "label", 53);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "div", 37)(13, "label", 57);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 62)(28, "strong");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div", 62)(35, "strong");
...
function SellComponent_ng_container_2_form_13_div_5_div_41_img_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const demo_r14 = \u0275\u0275nextContext().$implicit;
...
function SellComponent_ng_container_2_form_13_div_5_div_41_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const demo_r14 = ctx.$implicit;
    const i_r15 = ctx.index;
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", demo_r14.thumbnailUrl);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !demo_r14.thumbnailUrl);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", demo_r14.label);
    \u0275\u0275property("name", "demoLabel" + i_r15);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", demo_r14.url);
...
function SellComponent_ng_container_2_form_13_div_5_div_49_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 37)(4, "label", 103);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 37)(10, "label", 105);
    ...
    \u0275\u0275text(14, "A list of JSON paths the AI is strictly prohibited from touching.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 37)(16, "label", 107);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "span", 40);
    \u0275\u0275text(20, "Specific domain logic instructions for the AI.");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(4);
...
function SellComponent_ng_container_2_form_13_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 37)(5, "label", 64);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 37)(14, "label", 69);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 45)(18, "div", 37)(19, "label", 71);
    \u0275\u0275text(20, "File Size");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 37)(23, "label", 73);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 37)(27, "label", 75);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(30, "div", 37)(31, "label", 77);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "div", 37)(35, "div", 79)(36, "label", 80);
    ...
    \u0275\u0275text(46, "\u{1F916} Enable AI Deployment (Launch with AI)");
    \u0275\u0275elementEnd()();
...
function SellComponent_ng_container_2_form_13_div_6_div_54_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 125)(4, "pre", 126);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function SellComponent_ng_container_2_form_13_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 110)(10, "div", 111)(11, "span", 112);
    \u0275\u0275text(12, "\u{1F916}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "h4");
    \u0275\u0275text(14, "How to Create Your Deployment Guide");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 113)(16, "div", 114)(17, "span", 115);
    \u0275\u0275text(18, "1");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(24, "div", 114)(25, "span", 115);
    \u0275\u0275text(26, "2");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "div", 114)(33, "span", 115);
    \u0275\u0275text(34, "3");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(40, "div", 116)(41, "div", 117)(42, "span");
    ...
    \u0275\u0275text(45);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "pre", 119);
    \u0275\u0275text(47);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(48, "div", 120)(49, "label", 121);
...
function SellComponent_ng_container_2_form_13_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(33, "All submissions are reviewed by our team (2-3 business days)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "li");
    \u0275\u0275text(35, "Your deployment guide will be shown on the product page");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "li");
    \u0275\u0275text(37, "Ensure your code is well-documented and tested");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "li");
    \u0275\u0275text(39, "Remove any API keys or sensitive credentials");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "li");
    \u0275\u0275text(41, "You can track your submission status in ");
    \u0275\u0275elementStart(42, "a", 134);
    \u0275\u0275text(43, "My Submissions");
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
//# sourceMappingURL=chunk-5GLESSSA.js.map
