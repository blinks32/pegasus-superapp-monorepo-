...
function HomeComponent_a_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 25)(1, "div", 26)(2, "span");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "h3");
    \u0275\u0275text(5);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(9, _c1))("queryParams", \u0275\u0275pureFunction1(10, _c2, cat_r2.id));
    \u0275\u0275advance();
    \u0275\u0275styleProp("background", cat_r2.gradient);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(cat_r2.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(cat_r2.label);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(8, 7, cat_r2.count), " items");
  }
}
function HomeComponent_div_31_app_product_card_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-product-card", 30);
  }
  if (rf & 2) {
...
function HomeComponent_div_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, HomeComponent_div_31_app_product_card_1_Template, 1, 1, "app-product-card", 29);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r3.marketplace.products().slice(0, 12));
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["app-home"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 34, vars: 5, consts: [[1, "hero"], [1, "pm-container", "hero-content"], [1, "hero-title", "fade-in-up"], [1, "hero-gradient-text"], [1, "hero-subtitle", "fade-in-up"], [1, "pm-search-bar", "hero-search", "fade-in-up"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "#94A3B8", "stroke-width", "2"], ["cx", "11", "cy", "11", "r", "8"], ["d", "m21 21-4.3-4.3"], ["type", "text", "placeholder", "Search templates, scripts, plugins...", 3, "ngModelChange", "keyup.enter", "ngModel"], [3, "click"], [1, "hero-tags", "fade-in-up"], [1, "tag-label"], ["routerLink", "/browse", "class", "hero-tag", 3, "queryParams", 4, "ngFor", "ngForOf"], [1, "pm-section", "categories-section"], [1, "pm-container"], [1, "categories-grid", "stagger-children"], ["class", "category-card", 3, "routerLink", "queryParams", 4, "ngFor", "ngForOf"], [1, "pm-section"], [1, "section-header"], [1, "pm-heading-lg"], ["routerLink", "/browse", 1, "pm-btn", "pm-btn-outline", "pm-btn-sm"], ["class", "products-grid stagger-children", 4, "ngIf"], ["class", "empty-state", "style", "text-align: center; padding: 40px; background: var(--pm-surface-muted); border-radius: var(--pm-radius-md);", 4, "ngIf"], ["routerLink", "/browse", 1, "hero-tag", 3, "queryParams"], [1, "category-card", 3, "routerLink", "queryParams"], [1, "cat-icon-wrap"], [1, "cat-item-count"], [1, "products-grid", "stagger-children"], [3, "product", 4, "ngFor", "ngForOf"], [3, "product"], [1, "empty-state", 2, "text-align", "center", "padding", "40px", "background", "var(--pm-surface-muted)", "border-radius", "var(--pm-radius-md)"]], template: function HomeComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(19, "section", 14)(20, "div", 15)(21, "div", 16);
        \u0275\u0275template(22, HomeComponent_a_22_Template, 9, 12, "a", 17);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(23, "section", 18)(24, "div", 15)(25, "div", 19)(26, "div")(27, "h2", 20);
        \u0275\u0275text(28, "Latest Products");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(29, "a", 21);
        \u0275\u0275text(30, "View All \u2192");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(31, HomeComponent_div_31_Template, 2, 1, "div", 22)(32, HomeComponent_div_32_Template, 5, 0, "div", 23);
        \u0275\u0275elementEnd()();
