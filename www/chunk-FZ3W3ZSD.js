...
function AdminComponent_div_23_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, AdminComponent_div_23_div_2_span_8_Template, 2, 1, "span", 36);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminComponent_div_23_div_16_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminComponent_div_23_div_17_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminComponent_div_23_span_19_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminComponent_div_23_div_33_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AdminComponent_div_23_div_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 41)(1, "div", 42);
    \u0275\u0275template(2, AdminComponent_div_23_div_33_span_2_Template, 2, 1, "span", 43);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(16, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 51)(18, "a", 52);
    \u0275\u0275text(19, "View");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "button", 53);
    \u0275\u0275listener("click", function AdminComponent_div_23_div_33_Template_button_click_20_listener() {
      const project_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.openEditProduct(project_r7));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(21, "svg", 54);
    \u0275\u0275element(22, "path", 55)(23, "path", 56);
    \u0275\u0275elementEnd();
    \u0275\u0275text(24, " Edit ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(25, "button", 57);
    \u0275\u0275listener("click", function AdminComponent_div_23_div_33_Template_button_click_25_listener() {
      const project_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.deleteProduct(project_r7.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(26, "svg", 54);
    \u0275\u0275element(27, "path", 58);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function AdminComponent_div_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, AdminComponent_div_23_div_2_Template, 9, 6, "div", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 16)(4, "div", 17)(5, "h3");
    \u0275\u0275text(6, "Revenue Overview");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 18)(8, "button", 19);
    \u0275\u0275listener("click", function AdminComponent_div_23_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function AdminComponent_div_23_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminComponent_div_23_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(16, AdminComponent_div_23_div_16_Template, 4, 6, "div", 22)(17, AdminComponent_div_23_div_17_Template, 3, 0, "div", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 24);
    \u0275\u0275template(19, AdminComponent_div_23_span_19_Template, 2, 1, "span", 25);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "div", 26)(21, "div", 27)(22, "h3");
    \u0275\u0275text(23, "My Projects");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 28)(25, "button", 19);
    \u0275\u0275listener("click", function AdminComponent_div_23_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminComponent_div_23_Template_button_click_27_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminComponent_div_23_Template_button_click_29_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminComponent_div_23_Template_button_click_31_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(32, "Drafts");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(33, AdminComponent_div_23_div_33_Template, 28, 25, "div", 29)(34, AdminComponent_div_23_div_34_Template, 5, 0, "div", 30);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function AdminComponent_div_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 13)(1, "div", 61)(2, "div", 62)(3, "h3");
    \u0275\u0275text(4, "Admin Security Settings");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6, "Modify the authorized admin email and account credentials.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 63)(8, "div", 64)(9, "h4");
    \u0275\u0275text(10, "Authorized Email");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "p", 65);
    \u0275\u0275text(12, "Only this email + password can access the admin dashboard.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 66)(14, "input", 67);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_24_Template_input_ngModelChange_14_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminComponent_div_24_Template_button_click_15_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(17, "div", 69);
    \u0275\u0275elementStart(18, "div", 64)(19, "h4");
    \u0275\u0275text(20, "Change Account Password");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "p", 65);
    \u0275\u0275text(22, "Update the password for your current admin account.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "div", 70)(24, "div", 71)(25, "label");
    \u0275\u0275text(26, "Current Password");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "input", 72);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_24_Template_input_ngModelChange_27_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 71)(29, "label");
    \u0275\u0275text(30, "New Password");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "input", 73);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_24_Template_input_ngModelChange_31_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div", 71)(33, "label");
    \u0275\u0275text(34, "Confirm Password");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "input", 74);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_24_Template_input_ngModelChange_35_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(36, "button", 75);
    \u0275\u0275listener("click", function AdminComponent_div_24_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
...
function AdminComponent_div_25_div_13_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 83)(1, "div", 84)(2, "div", 85)(3, "h4");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 77)(6, "button", 86);
    \u0275\u0275listener("click", function AdminComponent_div_25_div_13_div_1_Template_button_click_6_listener() {
    ...
    \u0275\u0275element(8, "path", 55)(9, "path", 56);
    \u0275\u0275elementEnd();
    \u0275\u0275text(10, " Edit ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(11, "button", 87);
    \u0275\u0275listener("click", function AdminComponent_div_25_div_13_div_1_Template_button_click_11_listener() {
      const blog_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 89)(18, "span", 90);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "span", 91);
    \u0275\u0275text(21);
    \u0275\u0275pipe(22, "date");
    \u0275\u0275elementEnd()()()();
  }
...
function AdminComponent_div_25_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 81);
    \u0275\u0275template(1, AdminComponent_div_25_div_13_div_1_Template, 23, 9, "div", 82);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function AdminComponent_div_25_div_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 92);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 93);
    \u0275\u0275element(2, "path", 94)(3, "polyline", 95)(4, "line", 96)(5, "line", 97)(6, "polyline", 98);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(7, "h4");
...
function AdminComponent_div_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 76)(8, "div", 77)(9, "button", 78);
    \u0275\u0275listener("click", function AdminComponent_div_25_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(13, AdminComponent_div_25_div_13_Template, 2, 1, "div", 79)(14, AdminComponent_div_25_div_14_Template, 11, 0, "div", 80);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function AdminComponent_div_26_tr_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 104)(1, "td", 105);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(6, "slice");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "td", 106)(8, "strong");
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
...
function AdminComponent_div_26_div_23_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminComponent_div_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 99)(8, "table", 100)(9, "thead")(10, "tr", 101)(11, "th", 102);
    \u0275\u0275text(12, "Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "th", 102);
    \u0275\u0275text(14, "Product ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "th", 102);
    \u0275\u0275text(16, "IP Address");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "th", 102);
    \u0275\u0275text(18, "Location");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "th", 102);
    \u0275\u0275text(20, "Device Data");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(21, "tbody");
    \u0275\u0275template(22, AdminComponent_div_26_tr_22_Template, 14, 15, "tr", 103);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(23, AdminComponent_div_26_div_23_Template, 3, 0, "div", 80);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function AdminComponent_div_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminComponent_div_27_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeBlogModal());
    });
    \u0275\u0275elementStart(1, "div", 109);
    \u0275\u0275listener("click", function AdminComponent_div_27_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r13);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 110)(3, "h3");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 111);
    \u0275\u0275listener("click", function AdminComponent_div_27_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeBlogModal());
    });
    \u0275\u0275text(6, "\xD7");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 112)(8, "div", 71)(9, "label", 113);
    \u0275\u0275text(10, "Title *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "input", 114);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_27_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 71)(13, "label", 115);
    \u0275\u0275text(14, "Excerpt *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "textarea", 116);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_27_Template_textarea_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 71)(17, "label", 117);
    \u0275\u0275text(18, "Content *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "textarea", 118);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_27_Template_textarea_ngModelChange_19_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 71)(21, "label", 119)(22, "input", 120);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_27_Template_input_ngModelChange_22_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(24, "Published");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(25, "div", 121)(26, "button", 122);
    \u0275\u0275listener("click", function AdminComponent_div_27_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeBlogModal());
    });
    ...
    \u0275\u0275listener("click", function AdminComponent_div_27_Template_button_click_28_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
...
function AdminComponent_div_28_div_75_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminComponent_div_28_div_80_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 151);
    \u0275\u0275element(1, "img", 152);
    \u0275\u0275elementStart(2, "button", 153);
    \u0275\u0275listener("click", function AdminComponent_div_28_div_80_div_1_Template_button_click_2_listener() {
      const i_r17 = \u0275\u0275restoreView(_r16).index;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.removeEditScreenshot(i_r17));
    });
    \u0275\u0275text(3, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", img_r18, \u0275\u0275sanitizeUrl);
  }
}
function AdminComponent_div_28_div_80_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 149);
    \u0275\u0275template(1, AdminComponent_div_28_div_80_div_1_Template, 4, 1, "div", 150);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function AdminComponent_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 108);
    \u0275\u0275listener("click", function AdminComponent_div_28_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeEditModal());
    });
    \u0275\u0275elementStart(1, "div", 123);
    \u0275\u0275listener("click", function AdminComponent_div_28_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r14);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 110)(3, "h3");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 111);
    \u0275\u0275listener("click", function AdminComponent_div_28_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeEditModal());
    });
    \u0275\u0275text(6, "\xD7");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 124)(8, "div", 71)(9, "label");
    \u0275\u0275text(10, "Title");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "input", 125);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_textarea_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "textarea", 127);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_textarea_ngModelChange_19_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 128)(21, "div", 129)(22, "label");
    \u0275\u0275text(23, "Price (USD)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "input", 130);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 129)(26, "label");
    \u0275\u0275text(27, "Original Price");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "input", 130);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_28_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 129)(30, "label");
    \u0275\u0275text(31, "Version");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "input", 125);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_32_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(33, "div", 128)(34, "div", 129)(35, "label");
    \u0275\u0275text(36, "Category");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "select", 131);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_select_ngModelChange_37_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.editForm.category, $event) || (ctx_r2.editForm.category = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(38, AdminComponent_div_28_option_38_Template, 2, 3, "option", 132);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "div", 129)(40, "label");
    \u0275\u0275text(41, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "select", 131);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_select_ngModelChange_42_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.editForm.status, $event) || (ctx_r2.editForm.status = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(43, "option", 133);
    \u0275\u0275text(44, "Published");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "option", 134);
    \u0275\u0275text(46, "Draft");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "option", 135);
    \u0275\u0275text(48, "Pending");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "option", 136);
    \u0275\u0275text(50, "Rejected");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(51, "div", 128)(52, "div", 129)(53, "label");
    \u0275\u0275text(54, "Demo URL");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "input", 137);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_55_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(56, "div", 129)(57, "label");
    \u0275\u0275text(58, "YouTube Video URL");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "input", 138);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_59_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(60, "div", 71)(61, "label");
    \u0275\u0275text(62, "Tags (comma separated)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "input", 125);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_63_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(64, "div", 71)(65, "label");
    \u0275\u0275text(66, "Features (one per line)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(67, "textarea", 139);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_textarea_ngModelChange_67_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(68, "div", 71)(69, "label");
    \u0275\u0275text(70, "Tech Stack (comma separated)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "input", 125);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_71_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "div", 71)(73, "label");
    \u0275\u0275text(74, "Cover Image");
    \u0275\u0275elementEnd();
    \u0275\u0275template(75, AdminComponent_div_28_div_75_Template, 2, 1, "div", 140);
    \u0275\u0275elementStart(76, "input", 141);
    \u0275\u0275listener("change", function AdminComponent_div_28_Template_input_change_76_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onEditThumbnailSelect($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(77, "div", 71)(78, "label");
    \u0275\u0275text(79, "Screenshots (up to 5)");
    \u0275\u0275elementEnd();
    \u0275\u0275template(80, AdminComponent_div_28_div_80_Template, 2, 1, "div", 142);
    \u0275\u0275elementStart(81, "input", 143);
    \u0275\u0275listener("change", function AdminComponent_div_28_Template_input_change_81_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onEditScreenshotsSelect($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(82, "div", 144)(83, "label", 145)(84, "input", 120);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_84_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(85, " Featured ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(86, "label", 145)(87, "input", 120);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_87_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(88, " Bestseller ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(89, "label", 145)(90, "input", 120);
    \u0275\u0275twoWayListener("ngModelChange", function AdminComponent_div_28_Template_input_ngModelChange_90_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(91, " New ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(92, "div", 121)(93, "button", 122);
    \u0275\u0275listener("click", function AdminComponent_div_28_Template_button_click_93_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeEditModal());
    });
    \u0275\u0275text(94, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(95, "button", 68);
    \u0275\u0275listener("click", function AdminComponent_div_28_Template_button_click_95_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.saveEditProduct());
    });
    \u0275\u0275text(96, " \u{1F4BE} Save Changes ");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
  ...
  onEditScreenshotsSelect(event) {
    ...
    if (input.files) {
      Array.from(input.files).forEach((file) => {
        if (this.editForm.screenshotPreviews.length >= 5)
          return;
        const reader = new FileReader();
        reader.onload = (e) => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminComponent, selectors: [["app-admin"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 30, vars: 14, consts: [[1, "admin-hero"], [1, "pm-container"], [1, "hero-row"], [1, "pm-heading-lg"], [1, "pm-text-secondary"], [1, "hero-actions"], [1, "tab-btn", 3, "click"], ["routerLink", "/admin/submit", 1, "pm-btn", "pm-btn-primary"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M12 5v14M5 12h14"], [1, "pm-container", "admin-content"], ["class", "fade-in", 4, "ngIf"], ["class", "modal-overlay", 3, "click", 4, "ngIf"], [1, "fade-in"], [1, "stats-grid", "stagger-children"], ["class", "stat-card", 4, "ngFor", "ngForOf"], [1, "chart-card"], [1, "chart-header"], [1, "chart-tabs"], [3, "click"], [1, "chart-body"], [1, "chart-bars"], ["class", "chart-bar", 3, "height", 4, "ngFor", "ngForOf"], ["class", "empty-chart", 4, "ngIf"], [1, "chart-labels"], [4, "ngFor", "ngForOf"], [1, "projects-card"], [1, "card-header"], [1, "header-tabs"], ["class", "project-row", 4, "ngFor", "ngForOf"], ["class", "empty-projects", 4, "ngIf"], [1, "stat-card"], [1, "stat-card-icon"], [1, "stat-card-info"], [1, "stat-card-value"], [1, "stat-card-label"], ["class", "stat-card-change positive", 4, "ngIf"], [1, "stat-card-change", "positive"], [1, "chart-bar"], [1, "bar-tooltip"], [1, "empty-chart"], [1, "project-row"], [1, "project-thumb"], [4, "ngIf"], [1, "project-info"], [1, "project-title"], [1, "project-desc"], [1, "project-status"], [1, "status-badge"], [1, "project-price"], [1, "project-date"], [1, "project-actions"], [1, "pm-btn", "pm-btn-ghost", "pm-btn-sm", 3, "routerLink"], [1, "pm-btn", "pm-btn-ghost", "pm-btn-sm", 3, "click"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], [1, "pm-btn", "pm-btn-ghost", "pm-btn-sm", 2, "color", "#EF4444", 3, "click"], ["d", "M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"], [1, "empty-projects"], ["routerLink", "/admin/submit"], [1, "settings-card"], [1, "settings-header"], [1, "settings-form"], [1, "form-section"], [1, "section-desc"], [1, "form-group-row"], ["type", "email", "placeholder", "Admin email", 1, "pm-input", 3, "ngModelChange", "ngModel"], [1, "pm-btn", "pm-btn-primary", 3, "click", "disabled"], [1, "pm-divider"], [1, "form-grid"], [1, "form-group"], ["type", "password", "placeholder", "Enter current password", 1, "pm-input", 3, "ngModelChange", "ngModel"], ["type", "password", "placeholder", "Enter new password", 1, "pm-input", 3, "ngModelChange", "ngModel"], ["type", "password", "placeholder", "Repeat new password", 1, "pm-input", 3, "ngModelChange", "ngModel"], [1, "pm-btn", "pm-btn-primary", "mt-16", 3, "click", "disabled"], [1, "blog-management"], [1, "blog-actions"], [1, "pm-btn", "pm-btn-primary", 3, "click"], ["class", "blogs-list", 4, "ngIf"], ["class", "empty-state", 4, "ngIf"], [1, "blogs-list"], ["class", "blog-item", 4, "ngFor", "ngForOf"], [1, "blog-item"], [1, "blog-item-content"], [1, "blog-item-header"], [1, "pm-btn", "pm-btn-sm", "pm-btn-ghost", 3, "click"], [1, "pm-btn", "pm-btn-sm", "pm-btn-danger", 3, "click"], [1, "blog-excerpt"], [1, "blog-meta"], [1, "blog-status"], [1, "blog-date"], [1, "empty-state"], ["width", "48", "height", "48", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], ["d", "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"], ["points", "14 2 14 8 20 8"], ["x1", "16", "y1", "13", "x2", "8", "y2", "13"], ["x1", "16", "y1", "17", "x2", "8", "y2", "17"], ["points", "10 9 9 9 8 9"], [2, "overflow-x", "auto"], [1, "pm-table", 2, "width", "100%", "border-collapse", "collapse", "text-align", "left"], [2, "border-bottom", "2px solid var(--pm-border-light)"], [2, "padding", "12px", "color", "var(--pm-text-muted)"], ["style", "border-bottom: 1px solid var(--pm-border-light);", 4, "ngFor", "ngForOf"], [2, "border-bottom", "1px solid var(--pm-border-light)"], [2, "padding", "12px", "white-space", "nowrap"], [2, "padding", "12px"], [2, "padding", "12px", "font-size", "0.8rem", "color", "var(--pm-text-secondary)", "max-width", "250px", "overflow", "hidden", "text-overflow", "ellipsis", "white-space", "nowrap", 3, "title"], [1, "modal-overlay", 3, "click"], [1, "modal-content", 3, "click"], [1, "modal-header"], [1, "modal-close", 3, "click"], [1, "modal-body"], ["for", "blogTitle"], ["id", "blogTitle", "type", "text", "placeholder", "Enter blog title", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "blogExcerpt"], ["id", "blogExcerpt", "placeholder", "Short description (appears in listings)", "rows", "3", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "blogContent"], ["id", "blogContent", "placeholder", "Full blog content (supports HTML)", "rows", "10", 1, "form-input", 3, "ngModelChange", "ngModel"], [1, "checkbox-label"], ["type", "checkbox", 3, "ngModelChange", "ngModel"], [1, "modal-footer"], [1, "pm-btn", "pm-btn-ghost", 3, "click"], [1, "modal-content", 2, "max-width", "700px", 3, "click"], [1, "modal-body", 2, "max-height", "70vh", "overflow-y", "auto"], ["type", "text", 1, "form-input", 3, "ngModelChange", "ngModel"], ["rows", "2", 1, "form-input", 3, "ngModelChange", "ngModel"], ["rows", "6", 1, "form-input", 3, "ngModelChange", "ngModel"], [2, "display", "flex", "gap", "16px"], [1, "form-group", 2, "flex", "1"], ["type", "number", 1, "form-input", 3, "ngModelChange", "ngModel"], [1, "form-input", 3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], ["value", "published"], ["value", "draft"], ["value", "pending"], ["value", "rejected"], ["type", "url", "placeholder", "https://...", 1, "form-input", 3, "ngModelChange", "ngModel"], ["type", "url", "placeholder", "https://youtube.com/watch?v=...", 1, "form-input", 3, "ngModelChange", "ngModel"], ["rows", "4", 1, "form-input", 3, "ngModelChange", "ngModel"], ["style", "margin-bottom:8px", 4, "ngIf"], ["type", "file", "accept", "image/*", 1, "form-input", 3, "change"], ["style", "display:flex;gap:8px;flex-wrap:wrap;margin-bottom:8px", 4, "ngIf"], ["type", "file", "accept", "image/*", "multiple", "", 1, "form-input", 3, "change"], [2, "display", "flex", "gap", "12px", "align-items", "center", "margin-top", "8px"], [2, "display", "flex", "align-items", "center", "gap", "8px", "cursor", "pointer"], [3, "value"], [2, "margin-bottom", "8px"], [2, "max-width", "200px", "max-height", "120px", "border-radius", "8px", "object-fit", "cover", 3, "src"], [2, "display", "flex", "gap", "8px", "flex-wrap", "wrap", "margin-bottom", "8px"], ["style", "position:relative", 4, "ngFor", "ngForOf"], [2, "position", "relative"], [2, "width", "100px", "height", "70px", "border-radius", "6px", "object-fit", "cover", 3, "src"], [2, "position", "absolute", "top", "-6px", "right", "-6px", "width", "20px", "height", "20px", "border-radius", "50%", "background", "#EF4444", "color", "white", "border", "none", "font-size", "12px", "cursor", "pointer", "display", "flex", "align-items", "center", "justify-content", "center", 3, "click"]], template: function AdminComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(17, "Settings");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(18, "a", 7);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(19, "svg", 8);
        \u0275\u0275element(20, "path", 9);
        \u0275\u0275elementEnd();
        \u0275\u0275text(21, " Submit Project ");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275namespaceHTML();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminComponent, { className: "AdminComponent", filePath: "src\\app\\pages\\admin\\admin.component.ts", lineNumber: 875 });
})();
export {
  AdminComponent
};
//# sourceMappingURL=chunk-FZ3W3ZSD.js.map
