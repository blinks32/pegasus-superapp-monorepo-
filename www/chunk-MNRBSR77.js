...
var iosEnterAnimation = (baseEl, opts) => {
  ...
  const {
    ...
    arrowLeft,
    addPopoverBottomClass
  } = calculateWindowAdjustment(side, results.top, results.left, padding, bodyWidth, bodyHeight, contentWidth, contentHeight, safeArea, results.originX, results.originY, results.referenceCoordinates, results.arrowTop, results.arrowLeft, arrowHeight);
...
var mdEnterAnimation = (baseEl, opts) => {
  ...
  const {
    ...
    checkSafeAreaBottom,
    addPopoverBottomClass
  } = calculateWindowAdjustment(side, results.top, results.left, padding, bodyWidth, bodyHeight, contentWidth, contentHeight, safeArea, results.originX, results.originY, results.referenceCoordinates);
...
var Popover = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({
      ...
      key: "eb7886fbc99c15b667b7d825d24f1c12d9380f03"
    }))));
  }
  get el() {
...
//# sourceMappingURL=chunk-MNRBSR77.js.map
