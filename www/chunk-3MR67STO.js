...
var r = (t3) => {
  ...
  const M2 = t3, W2 = [], I = [], K = [], P3 = [], Z = [], x2 = [], B2 = [], J = [], q = [], z2 = [], G = [], H = "function" == typeof AnimationEffect || void 0 !== d && "function" == typeof d.AnimationEffect, L2 = "function" == typeof Element && "function" == typeof Element.prototype.animate && H, N = () => G, O = (e, o) => {
    ...
    t4 > -1 && o.splice(t4, 1);
  }, Q = (e, o) => (((null == o ? void 0 : o.oneTimeCallback) ? I : W2).push({
    c: e,
    o
  }), p2), U2 = () => {
    L2 && (G.forEach((e) => {
    ...
    (null == e ? void 0 : e.sync) && (k2 = true, Q(() => k2 = false, {
      oneTimeCallback: true
    })), b2 || ie(), T && (L2 && (ne(0), re()), T = false), D2 && (S = Z.length + 1, D2 = false);
    const t4 = () => {
      O(i2, I), o();
    }, i2 = () => {
      O(t4, K), o();
    ...
    const t4 = y2[0];
    return void 0 === t4 || void 0 !== t4.offset && 0 !== t4.offset ? y2 = [{
      offset: 0,
      [e]: o
    }, ...y2] : t4[e] = o, p2;
  };
  return p2 = {
    ...
    to: (e, o) => {
      ...
      return void 0 === t4 || void 0 !== t4.offset && 1 !== t4.offset ? y2 = [...y2, {
        offset: 1,
        [e]: o
      }] : t4[e] = o, p2;
    },
    fromTo: (e, o, t4) => le(e, o).to(e, t4),
    parent: (e) => (c2 = e, p2),
    play: de,
    pause: () => (Z.forEach((e) => {
      e.pause();
    ...
    destroy: (e) => (Z.forEach((o) => {
      ...
      U2(), e2 && V2();
    })(e), P3.length = 0, Z.length = 0, y2.length = 0, W2.length = 0, I.length = 0, b2 = false, D2 = true, p2),
    keyframes: (e) => {
      const o = y2 !== e;
      return y2 = e, o && ((e2) => {
        L2 && N().forEach((o2) => {
    ...
    update: ae,
    fill: (e) => (l2 = e, ae(true), p2),
    direction: (e) => (f3 = e, ae(true), p2),
    iterations: (e) => (d4 = e, ae(true), p2),
    duration: (e) => (L2 || 0 !== e || (e = 1), a = e, ae(true), p2),
    easing: (e) => (s2 = e, ae(true), p2),
    delay: (e) => (r3 = e, ae(true), p2),
    getWebAnimations: N,
    getKeyframes: () => y2,
    getFill: X,
    getDirection: Y,
    ...
    getEasing: $,
    getDuration: _,
    afterAddRead: (e) => (q.push(e), p2),
    afterAddWrite: (e) => (z2.push(e), p2),
    afterClearStyles: (e = []) => {
      for (const o of e) R[o] = "";
      return p2;
    },
    afterStyles: (e = {}) => (R = e, p2),
    afterRemoveClass: (e) => (h3 = n2(h3, e), p2),
    afterAddClass: (e) => (E2 = n2(E2, e), p2),
    beforeAddRead: (e) => (B2.push(e), p2),
    beforeAddWrite: (e) => (J.push(e), p2),
    beforeClearStyles: (e = []) => {
      for (const o of e) C2[o] = "";
      return p2;
    },
    beforeStyles: (e = {}) => (C2 = e, p2),
    beforeRemoveClass: (e) => (A = n2(A, e), p2),
    beforeAddClass: (e) => (g2 = n2(g2, e), p2),
    onFinish: Q,
    isRunning: () => 0 !== S && !F,
    progressStart: (e = false, o) => (Z.forEach((t4) => {
      t4.progressStart(e, o);
    }), se(), j2 = e, b2 || ie(), ae(false, true, o), p2),
    progressStep: (e) => (Z.forEach((o) => {
      o.progressStep(e);
    }), ne(e), p2),
    progressEnd: (e, o, t4) => (j2 = false, Z.forEach((i2) => {
...
var g = (n3) => __async(void 0, null, function* () {
  const e = yield h2(n3);
...
var h2 = (n3) => __async(void 0, null, function* () {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (yield import("./chunk-4EPBQSDB.js")).iosTransitionAnimation : (yield import("./chunk-ODJJMHQK.js")).mdTransitionAnimation;
});
var y = (n3, e) => __async(void 0, null, function* () {
  yield k(e, true);
...
var B = (n3) => __async(void 0, null, function* () {
  const e = n3;
  if (e) {
...
//# sourceMappingURL=chunk-3MR67STO.js.map
