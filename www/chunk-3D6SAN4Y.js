...
function HomeComponent_div_28_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "div", 28)(4, "div", 29)(5, "div", 30)(6, "div", 31);
    \u0275\u0275elementEnd()();
  }
}
function HomeComponent_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, HomeComponent_div_28_div_1_Template, 7, 0, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function HomeComponent_div_29_app_product_card_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-product-card", 33);
  }
  if (rf & 2) {
...
function HomeComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275template(1, HomeComponent_div_29_app_product_card_1_Template, 1, 1, "app-product-card", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["app-home"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 32, vars: 5, consts: [[1, "page-enter"], [1, "hero"], [1, "pm-container", "hero-content"], [1, "hero-title", "fade-in-up"], [1, "hero-gradient-text"], [1, "hero-subtitle", "fade-in-up"], [1, "pm-search-bar", "hero-search", "fade-in-up"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "#94A3B8", "stroke-width", "2"], ["cx", "11", "cy", "11", "r", "8"], ["d", "m21 21-4.3-4.3"], ["type", "text", "placeholder", "Search templates, scripts, plugins...", 3, "ngModelChange", "keyup.enter", "ngModel"], [3, "click"], [1, "hero-tags", "fade-in-up"], [1, "tag-label"], ["routerLink", "/browse", "class", "hero-tag", 3, "queryParams", 4, "ngFor", "ngForOf"], [1, "pm-section"], [1, "pm-container"], [1, "section-header"], [1, "pm-heading-lg"], ["routerLink", "/browse", 1, "pm-btn", "pm-btn-outline", "pm-btn-sm"], ["class", "products-grid stagger-children", 4, "ngIf"], ["class", "empty-state", "style", "text-align: center; padding: 40px; background: var(--pm-surface-muted); border-radius: var(--pm-radius-md);", 4, "ngIf"], ["routerLink", "/browse", 1, "hero-tag", 3, "queryParams"], [1, "products-grid", "stagger-children"], ["class", "product-skeleton", "style", "background:var(--pm-surface); border-radius:var(--pm-radius-lg); height:330px; animation: pulse 1.5s infinite;", 4, "ngFor", "ngForOf"], [1, "product-skeleton", 2, "background", "var(--pm-surface)", "border-radius", "var(--pm-radius-lg)", "height", "330px", "animation", "pulse 1.5s infinite"], [2, "height", "160px", "background", "var(--pm-surface-muted)", "width", "100%"], [2, "padding", "16px"], [2, "height", "20px", "background", "var(--pm-surface-muted)", "width", "70%", "margin-bottom", "12px"], [2, "height", "14px", "background", "var(--pm-surface-muted)", "width", "100%", "margin-bottom", "8px"], [2, "height", "14px", "background", "var(--pm-surface-muted)", "width", "80%", "margin-bottom", "20px"], [2, "height", "24px", "background", "var(--pm-surface-muted)", "width", "40%"], [3, "product", 4, "ngFor", "ngForOf"], [3, "product"], [1, "empty-state", 2, "text-align", "center", "padding", "40px", "background", "var(--pm-surface-muted)", "border-radius", "var(--pm-radius-md)"]], template: function HomeComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(27, "View All \u2192");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(28, HomeComponent_div_28_Template, 2, 2, "div", 20)(29, HomeComponent_div_29_Template, 2, 1, "div", 20)(30, HomeComponent_div_30_Template, 5, 0, "div", 21);
        \u0275\u0275elementEnd()()();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(9);
        \u0275\u0275property("ngIf", ctx.marketplace.isLoading());
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.marketplace.isLoading() && ctx.marketplace.products().length > 0);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.marketplace.isLoading() && ctx.marketplace.products().length === 0);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HomeComponent, { className: "HomeComponent", filePath: "src\\app\\pages\\home\\home.component.ts", lineNumber: 191 });
})();
export {
  HomeComponent
};
//# sourceMappingURL=chunk-3D6SAN4Y.js.map
