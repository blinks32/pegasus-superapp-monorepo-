...
var _c0 = () => [1, 2, 3, 4, 5, 6];
var _c1 = (a0) => ["/blog", a0];
function BlogsComponent_div_10_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function BlogsComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, BlogsComponent_div_10_div_1_Template, 6, 0, "div", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function BlogsComponent_div_11_article_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "h2", 22)(8, "a", 23);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "p", 24);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "a", 25);
    \u0275\u0275text(13, " Read Article ");
    \u0275\u0275namespaceSVG();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(6, 7, \u0275\u0275pipeBind1(5, 5, blog_r1.createdAt), "mediumDate"));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(12, _c1, blog_r1.id));
  }
}
function BlogsComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275template(1, BlogsComponent_div_11_article_1_Template, 16, 14, "article", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
