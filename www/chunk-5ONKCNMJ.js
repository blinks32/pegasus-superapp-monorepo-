...
function AdminComponent_div_19_div_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(16, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 49)(18, "button", 50);
    \u0275\u0275text(19, "Edit");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275classMap("status-" + project_r6.status);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 10, project_r6.status), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("$", project_r6.price, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(16, 12, project_r6.createdAt, "mediumDate"));
  }
}
...
function AdminComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminComponent_div_19_Template_button_click_8_listener() {
      ...
      return \u0275\u0275resetView(ctx_r2.chartPeriod = "7d");
    });
    \u0275\u0275text(9, "7 Days");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AdminComponent_div_19_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.chartPeriod = "30d");
    });
    \u0275\u0275text(11, "30 Days");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AdminComponent_div_19_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.chartPeriod = "12m");
    });
    \u0275\u0275text(13, "12 Months");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(32, "Drafts");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(33, AdminComponent_div_19_div_33_Template, 20, 15, "div", 28)(34, AdminComponent_div_19_div_34_Template, 5, 0, "div", 29);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.chartData.length === 0);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r2.chartData);
    \u0275\u0275advance(6);
...
function AdminComponent_div_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(12, "Only this email will be allowed to access the admin dashboard.");
    \u0275\u0275elementEnd();
...
var AdminComponent = class _AdminComponent {
  constructor() {
    ...
    this.chartData = [];
    this.allProjects = [];
    this.newAdminEmail = "chndth@gmail.com";
    this.newPassword = "";
  ...
  updateAdminEmail() {
    return __async(this, null, function* () {
      ...
      try {
        yield updateDoc(doc(this.firestore, "settings/admin"), { email: this.newAdminEmail });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminComponent, { className: "AdminComponent", filePath: "src\\app\\pages\\admin\\admin.component.ts", lineNumber: 220 });
})();
export {
  AdminComponent
};
//# sourceMappingURL=chunk-5ONKCNMJ.js.map
