...
function LoginComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function LoginComponent_div_21_Template_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r1);
...
function LoginComponent_span_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LoginComponent_span_34_Template_a_click_2_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
var LoginComponent = class _LoginComponent {
  ...
  static {
    this.\u0275fac = function LoginComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LoginComponent)(\u0275\u0275directiveInject(ActivatedRoute));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 37, vars: 9, consts: [[1, "login-page"], [1, "pm-container"], [1, "login-wrapper"], [1, "login-card"], [1, "login-title"], [1, "login-subtitle"], [1, "social-login"], [1, "pm-btn", "pm-btn-outline", "google-btn"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "xmlns", "http://www.w3.org/2000/svg"], ["d", "M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z", "fill", "#4285F4"], ["d", "M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z", "fill", "#34A853"], ["d", "M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z", "fill", "#FBBC05"], ["d", "M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z", "fill", "#EA4335"], [1, "divider"], [1, "login-form"], ["class", "form-group", 4, "ngIf"], [1, "form-group"], ["type", "email", "placeholder", "john@example.com", "name", "email", 3, "ngModelChange", "ngModel"], ["type", "password", "placeholder", "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", "name", "password", 3, "ngModelChange", "ngModel"], ["class", "form-options", 4, "ngIf"], ["type", "button", 1, "pm-btn", "pm-btn-primary", "pm-btn-lg", "w-full"], [1, "auth-switch"], [4, "ngIf"], ["type", "text", "placeholder", "John Doe", "name", "name", 3, "ngModelChange", "ngModel"], [1, "form-options"], [1, "remember-me"], ["type", "checkbox", "name", "remember"], ["href", "#", 1, "forgot-pwd"], ["href", "javascript:void(0)", 3, "click"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(21, LoginComponent_div_21_Template, 4, 1, "div", 15);
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275template(30, LoginComponent_div_30_Template, 7, 0, "div", 19);
        \u0275\u0275elementStart(31, "button", 20);
        \u0275\u0275text(32);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(33, "div", 21);
        \u0275\u0275template(34, LoginComponent_span_34_Template, 4, 0, "span", 22)(35, LoginComponent_span_35_Template, 4, 0, "span", 22);
        \u0275\u0275elementEnd()()()()();
