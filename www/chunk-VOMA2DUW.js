...
function GuideComponent_div_29_ng_container_1_div_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 31);
  }
  if (rf & 2) {
...
function GuideComponent_div_29_ng_container_1_div_1_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function GuideComponent_div_29_ng_container_1_div_1_div_16_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const step_r2 = \u0275\u0275nextContext(2).$implicit;
...
function GuideComponent_div_29_ng_container_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 20)(1, "div", 21)(2, "div", 22);
    \u0275\u0275element(3, "ion-icon", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, GuideComponent_div_29_ng_container_1_div_1_div_4_Template, 1, 2, "div", 23);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275template(16, GuideComponent_div_29_ng_container_1_div_1_div_16_Template, 5, 1, "div", 27);
    \u0275\u0275elementStart(17, "div", 28);
    \u0275\u0275listener("click", function GuideComponent_div_29_ng_container_1_div_1_Template_div_click_17_listener() {
      \u0275\u0275restoreView(_r1);
...
function GuideComponent_div_29_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, GuideComponent_div_29_ng_container_1_div_1_Template, 22, 20, "div", 19);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function GuideComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, GuideComponent_div_29_ng_container_1_Template, 2, 1, "ng-container", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GuideComponent_div_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function GuideComponent_div_30_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function GuideComponent_div_30_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GuideComponent, selectors: [["app-guide"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 32, vars: 16, consts: [[1, "guide-page"], [1, "guide-container"], [1, "guide-header", "fade-in"], [1, "badge"], [1, "guide-tabs", "fade-in-up", 2, "animation-delay", "100ms"], [1, "tab-btn", 3, "click"], ["name", "construct-outline"], ["name", "flash-outline"], [1, "guide-card", "fade-in-up", 2, "animation-delay", "200ms"], [1, "card-top"], [1, "progress-info"], [1, "progress-bar-wrap"], [1, "progress-bar-fill"], [1, "view-toggle", 3, "click"], [3, "name"], ["class", "step-content", 4, "ngIf"], ["class", "success-screen", 4, "ngIf"], [1, "step-content"], [4, "ngFor", "ngForOf"], ["class", "step-item", 3, "animation-delay", 4, "ngIf"], [1, "step-item"], [1, "step-connector"], [1, "step-icon-circle"], ["class", "line", 3, "completed", 4, "ngIf"], [1, "step-details"], [1, "step-meta"], [1, "pm-badge"], ["class", "code-block", 4, "ngIf"], [1, "completion-check", 3, "click"], [1, "checkbox"], ["name", "checkmark-sharp"], [1, "line"], [1, "code-block"], ["title", "Copy to clipboard", 1, "copy-btn", 3, "click"], ["name", "copy-outline"], [1, "success-screen"], [1, "success-icon"], ["name", "trophy-outline"], [2, "display", "flex", "gap", "16px", "justify-content", "center"], [1, "pm-btn", "pm-btn-primary", 3, "click"], ["name", "refresh-outline"], [1, "pm-btn", "pm-btn-outline", 3, "click"]], template: function GuideComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function GuideComponent_Template_button_click_26_listener() {
          return ctx.toggleShowAll();
        });
        \u0275\u0275element(27, "ion-icon", 14);
        \u0275\u0275text(28);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(29, GuideComponent_div_29_Template, 2, 1, "div", 15)(30, GuideComponent_div_30_Template, 13, 2, "div", 16);
        \u0275\u0275elementEnd()()()();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate1("MISSION PROGRESS: ", \u0275\u0275pipeBind2(23, 13, ctx.progress, "1.0-0"), "%");
        \u0275\u0275advance(3);
