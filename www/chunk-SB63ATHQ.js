...
function BlogsComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, BlogsComponent_div_11_article_1_Template, 15, 12, "article", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
