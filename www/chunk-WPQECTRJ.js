...
var Range = class {
  constructor(hostRef) {
    ...
    this.setupGesture = () => __async(this, null, function* () {
      ...
      if (rangeSlider) {
        this.gesture = (yield import("./chunk-2WK4OUCT.js")).createGesture({
          el: rangeSlider,
          gestureName: "range",
          gesturePriority: 100,
          /**
  ...
  render() {
    ...
    return h(Host, {
      key: "f8063d1234fb113fe55a7902845dd4b4da8b1edb",
      ...
      key: "beead65ab01e3b18e4be59c0ee8ac6ebf32aad7c",
      class: "range-wrapper",
      id: "range-label"
    }, h("div", {
      key: "03633c689d9d2e4c50a2131bcd560329df49e314",
      class: {
      ...
      key: "c066804263ab6ae7393f8dcc51184b7198844ffa",
      class: "native-wrapper"
    }, h("slot", {
      key: "7e8ea224d72b3e965dd948bee7e45c1a096b6899",
      name: "start"
    }), this.renderRangeSlider(), h("slot", {
      key: "21f242f6f60ff3adce6a2d90b2d4dac1ceaf6624",
      name: "end"
    }))));
  }
  get el() {
...
var renderKnob = (rtl, {
  ...
  return h("div", {
    ...
    part: ["knob-handle", dualKnobs && knob === "A" && "knob-handle-a", dualKnobs && knob === "B" && "knob-handle-b", dualKnobs && position === "lower" && "knob-handle-lower", dualKnobs && position === "upper" && "knob-handle-upper", pressed && "pressed", focused && "focused", hovered && "hover", activated && "activated"].filter(Boolean).join(" "),
    style: knobStyle(),
    role: "slider",
    ...
    class: "range-pin",
    role: "presentation",
    part: ["pin", dualKnobs && knob === "A" && "pin-a", dualKnobs && knob === "B" && "pin-b", dualKnobs && position === "lower" && "pin-lower", dualKnobs && position === "upper" && "pin-upper", pressed && "pressed", focused && "focused", hovered && "hover", activated && "activated"].filter(Boolean).join(" ")
  }, pinFormatter(value)), h("div", {
    class: "range-knob",
    role: "presentation",
    part: ["knob", dualKnobs && knob === "A" && "knob-a", dualKnobs && knob === "B" && "knob-b", dualKnobs && position === "lower" && "knob-lower", dualKnobs && position === "upper" && "knob-upper", pressed && "pressed", focused && "focused", hovered && "hover", activated && "activated"].filter(Boolean).join(" ")
  }));
};
...
//# sourceMappingURL=chunk-WPQECTRJ.js.map
