...
function SellComponent_ng_container_2_form_13_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(53, "Supports plain text formatting. Include prerequisites, installation steps, environment setup, and deployment instructions.");
    \u0275\u0275elementEnd()();
...
var SellComponent = class _SellComponent {
  constructor() {
    ...
    this.aiPromptTemplate = `Generate a comprehensive deployment guide for my project called "[YOUR PROJECT NAME]" built with [YOUR TECH STACK].
...
//# sourceMappingURL=chunk-OSPNRV5V.js.map
