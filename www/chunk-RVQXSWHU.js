...
var ImageUploadService = class _ImageUploadService {
  ...
  upload(data, path = "general") {
    return __async(this, null, function* () {
      ...
      try {
        if (base64String.length > 2e5) {
          const compressed = yield this.compressImage(data, 1280, 0.7);
        ...
        yield uploadString(storageRef, base64String, "base64", {
  ...
  static {
    this.\u0275fac = function ImageUploadService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ImageUploadService)(\u0275\u0275inject(Auth));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ImageUploadService, factory: _ImageUploadService.\u0275fac, providedIn: "root" });
  }
};
...
//# sourceMappingURL=chunk-RVQXSWHU.js.map
