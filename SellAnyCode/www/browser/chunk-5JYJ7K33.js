...
var i = (s) => __async(void 0, null, function* () {
  return e2(s) ? (yield new Promise((t2) => e(s, t2)), s.getScrollElement()) : s;
});
var n = (o) => o.querySelector(a2) || o.querySelector(r);
var f = (o) => o.closest(r);
var m = (o, s) => e2(o) ? o.scrollToTop(s) : Promise.resolve(o.scrollTo({
  top: 0,
  left: 0,
  behavior: "smooth"
}));
var c = (o, s, t2, a3) => e2(o) ? o.scrollByPoint(s, t2, a3) : Promise.resolve(o.scrollBy({
  top: t2,
  left: s,
  behavior: a3 > 0 ? "smooth" : "auto"
}));
var p = (o) => a(o, t);
var h = (o) => {
  if (e2(o)) {
...
//# sourceMappingURL=chunk-5JYJ7K33.js.map
