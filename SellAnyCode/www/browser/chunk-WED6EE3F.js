...
var h = new class {
  ...
  capture(t2, s3, i3) {
    ...
    if (h2.forEach((t3) => {
      ...
      const i4 = new CustomEvent("ionGestureCaptured", {
        detail: {
          gestureName: t2
        }
      });
...
var s2 = (o2) => {
  ...
  const l = Object.assign({
    ...
    maxAngle: 40,
    threshold: 10
  }, o2), v = l.canStart, m = l.onWillStart, p = l.onStart, f = l.onEnd, y = l.notCaptured, h2 = l.onMove, _ = l.threshold, b = l.passive, D = l.blurOnStart, E = {
    type: "pan",
    startX: 0,
    startY: 0,
    startTime: 0,
  ...
  })(l.direction, l.threshold, l.maxAngle), x = h.createGesture({
    name: o2.gestureName,
    priority: o2.gesturePriority,
    disableScroll: o2.disableScroll
  }), L = () => {
    n2 && (u = false, h2 && h2(E));
...
//# sourceMappingURL=chunk-WED6EE3F.js.map
