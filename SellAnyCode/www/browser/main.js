...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-XC4F4FGF.js").then((m) => m.LoginComponent)
  },
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-MIPOHJRE.js").then((m) => m.DashboardComponent),
    canActivate: [authGuard]
  },
  {
    path: "topic/:id",
    loadComponent: () => import("./chunk-2UFRMB5S.js").then((m) => m.TopicDetailComponent),
    canActivate: [authGuard]
  },
  {
    path: "certificate/:topicId",
    loadComponent: () => import("./chunk-PKIQKRKL.js").then((m) => m.CertificateComponent),
    canActivate: [authGuard]
  }
];
